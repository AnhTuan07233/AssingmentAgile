  ...
  <div className="inner">
    ...
    <section id="three" className="wrapper">
      <div className="spotlight">
        <div className="image flush"><img src="http://lorempixel.com/640/480/food" alt /></div>
        <div className="inner">
      ...
      <div className="spotlight alt">
        <div className="image flush"><img src="http://lorempixel.com/640/480/fashion" alt /></div>
        <div className="inner">
